...
if not summary.empty:
    top=summary.loc[summary.TotalRevenue.idxmax()]; risk=summary[summary.Segmen=='Lost/Churned']
    risk_text=f"Segmen Lost/Churned mencakup {risk.iloc[0].Persentase:.1f}% pelanggan." if not risk.empty else "Filter saat ini tidak menampilkan segmen Lost/Churned."
