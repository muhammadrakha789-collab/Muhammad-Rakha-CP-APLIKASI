...
if uploaded is None:
    st.markdown("<div class='insight'><b>Pipeline 4 tahap:</b> Validate & Clean → Calculate RFM → Evaluate k → Cluster & Export. Gunakan CSV dengan struktur transaksi yang konsisten.</div>",unsafe_allow_html=True);st.stop()
try:
    ...
    st.markdown("<div class='insight'><b>Cleaning selesai.</b> Retur, quantity/price tidak valid, customer kosong, duplikasi, dan tanggal tidak valid telah disaring sebelum analisis RFM.</div>",unsafe_allow_html=True)
